      ...
      {getCart && !loading && (
        <>
          ...
          <AddressCardComponent
            address={getCart.shippingAddress}
            btnTitle="Change"
            handleBtn={() => history.push(`/demo/shipping-address`)}
          />
          <Row type="flex" align="middle">
            ...
            <Col span={12}>
              <Row type="flex" justify="end">
                <Button type="link" style={{ color: '#DB3022' }} onClick={() => history.push(`/demo/payment-methods`)}>
                  Change
                </Button>
              </Row>
            </Col>
            <Col span={24}>
              <Row type="flex" align="middle">
                ...
                <Col span={18}>
                  <Number>{`**** **** **** ${getCart.paymentMethod.cardNumber.substr(
                    getCart.paymentMethod.cardNumber.length - 4
                  )}`}</Number>
                </Col>
              </Row>
            </Col>
            <Col span={24} style={{ paddingTop: '50px' }}>
              ...
              <Col span={24}>
                <Row type="flex" justify="space-between">
                  <DeliveryMetBtn>Self Pickup</DeliveryMetBtn>
                  <DeliveryMetBtn>
                    <img alt="" src={Danzo} />
                    Dunzo
                  </DeliveryMetBtn>
            ...
            <Col span={24} style={{ paddingTop: '52px' }}>
              <Row type="flex" align="middle" justify="center">
                ...
                <Col span={14}>
                  <Row type="flex" align="end">
                    <h3>
                      <strong>Rs. {totalAmount(getCart.orderDetails)}</strong>
                    </h3>
                  </Row>
                </Col>
              </Row>
            ...
            <Col span={24}>
              <Row type="flex" align="middle" justify="center">
                ...
                <Col span={14}>
                  <Row type="flex" align="end">
                    <h3>
                      <strong>Rs. {getCart.delivery}</strong>
                    </h3>
                  </Row>
                </Col>
              </Row>
            ...
            <Col span={24}>
              <Row type="flex" align="middle" justify="center">
                ...
                <Col span={14}>
                  <Row type="flex" align="end">
                    <h3>
                      <strong>Rs. {totalAmount(getCart.orderDetails) + getCart.delivery}</strong>
                    </h3>
                  </Row>
                </Col>
              </Row>
